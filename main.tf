...
# resource "google_service_account" "mmjuiceshop" {
#   account_id   = "mmjuiceshop"
...
resource "google_container_node_pool" "primary_nodes" {
  ...
  node_config {
    ...
    preemptible     = false
    service_account = "mmjuiceshop@martins-juice-shop.iam.gserviceaccount.com"
    tags            = ["allow-http", "allow-helth-check", "allow-ssh"]
...
resource "google_project_iam_member" "project" {
  ...
  member  = "serviceAccount:mmjuiceshop@martins-juice-shop.iam.gserviceaccount.com"
}
